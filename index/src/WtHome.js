            ...
            <div>
                <header className="header">
                    <div className="logo" style={{float:'left',color:'#808080',height:62}}>
                        <span style={{fontSize:20,color:'#001529'}}>违纪员工管理系统<span className="student-version" >V{config.version}</span></span>
                    </div>

                    <div style={{float:'right',color:'#808080',height:62}}>
                        <span style={{padding:'0 20px',color:'#001529'}}>名字</span>
                        <a href="javascript:" style={{padding:'0 20px',color:'#001529'}} onClick={this.onLogout}>退出</a>
                    </div>
                </header>
